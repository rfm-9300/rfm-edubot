...
data class MobileCopy(
    ...
    val waiting: String = "Waiting", val collectedMonth: String = "Received this month", val outstanding: String = "To collect",
    val bookingsToday: String = "Bookings today", val pendingBookings: String = "To confirm",
) {
