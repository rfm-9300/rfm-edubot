...
data class MobileCopy(
    ...
    val waiting: String = "Waiting", val collectedMonth: String = "Collected this month", val outstanding: String = "To collect",
