...
This project is indexed by GitNexus as **rfm-edubot** (6469 symbols, 14068 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
